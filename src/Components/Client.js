...
const ClientInfoSet = ({open, close, submitForm}) => {
	...
	const handleSub = (e) => {
		...
		submitForm({'name': thisName, 'last': last, 'phone': phone, 'email': thisEmail, 'address': location});
				...
				<div className="myModal">
					...
					<form method="post" onSubmit={handleSub} >
					  ...
					  <div class="form-group">
					    ...
					    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"  onChange={(e) =>setLocation(e.target.value)}>{location}</textarea>
					  </div>
					  <br />
